            ...
            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <div class="nav flex-column nav-pills me-3 mt-3" role="tablist" aria-orientation="vertical">
                                        <nav class="nav flex-column">
                                            ...
                                            <a class="nav-link" href="adminBooking.php">Booking Details</a>
                                            <a class="nav-link active" aria-current="page" href="adminManageContent.php">Manage Content</a>
                                            <a class="nav-link" href="subscribeList.php">Subscribe List</a>
                                            <a class="nav-link " href="adminReview.php">Manage Review</a>
                                        </nav>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'HomeIframeChange.php'">
                            <h1>Change Home Iframe Change</h1>
                        </div>
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'imageGalleryChange.php'">
                            <h1>Change Image Gallery</h1>
                        </div>
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'aboutChange.php'">
                            <h1>Change About</h1>
                        </div>
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'VideoChange.php'">
                            <h1>Change Video</h1>
                        </div>
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'categoryImageChange.php'">
                            <h1>Change Category Image</h1>
                        </div>
                        <div class="col-12 btn btn-outline-dark" onclick="window.location = 'HomePageTextChage.php'">
                            <h1>Change HomePage Text</h1>
                        </div>
