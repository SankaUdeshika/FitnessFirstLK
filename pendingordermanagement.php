...
<body id="reportsPage">
    <div class="" id="home">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-5 mb-5">Welcome back, <b>Pending Order management</b></p>
                </div>
            </div>
            <!-- row -->
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php
                                $Order_rs = FlexDatabase::Search("SELECT * FROM `order` INNER JOIN `user` ON `user`.`Email` = `order`.`User_Email` INNER JOIN `status` ON  `status`.`Sid` = `order`.`Status_Sid` WHERE `Sid` = '3'  ");
