...
?>
    ...
    <head>
        ...
        <title>Admin Dashboard | RASIKA OFFICIAL</title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 ml-3 mx-3 bg-primary rounded  ">
                            <div class="row">
                                ...
                                <div class="col-12 text-black  border-0 border-bottom 1 border-dark ">
                                    <div class="row">
                                        <div class="col-8">
                                            <input type="text" placeholder="Please Enter a Email" class="form-control">
                                        </div>
                                        <div class="col-4">
                                            <button class="btn btn-info">Send from email</button>
                                        </div>
                                        <div class="col-12">
