...
<body>
    <form action="<?php echo $url; ?>" method="POST">
        ...
        Bulk Payment Gateway IDs<input type="text" name="multiple_payment_gateway_ids" value="" placeholder="|  
seperated ids"> <br />
        ...
        WEBXPAY Gateway Integration Guide v2.7
        Page | 11
        ...
        <!-- POST parameters -->
        <input type="hidden" name="secret_key" value="02588ab1-08fb-49a4-a233-8b418730eee0">
