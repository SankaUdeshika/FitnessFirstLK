            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <div class="flex justify-center text-teal-300 sm:justify-start">
                        <img src="Resources/images/LOGO/FitnessfirstLOGOTransparent.png" width="70%" class="mx-auto" alt="" srcset="">
                    </div>
                    ...
                    <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
                        <li>
                            <a
                                href="https://web.facebook.com/fitnessfirstSL"
                        ...
                        <li>
                            <a
                                href="https://www.instagram.com/fitnessfirstlk/"
                                rel="noopener noreferrer"
                                target="_blank"
                                class="text-rose-600 transition hover:text-rose-500/75">
                        ...
                        <li>
                            <a
                                href="https://www.tiktok.com/@fitnessfirstlk"
                                rel="noopener noreferrer"
                                target="_blank"
                                class="text-rose-600 transition hover:text-rose-500/75">
                                ...
                                <svg
                                    ...
                                    aria-hidden="true">
                                    <path
                                        d="M448,209.9v96.4c-9.9,1.3-19.9,2.1-30.2,2.1c-48.8,0-90.7-24.5-116.3-61.7v126.7c0,64.2-52.2,116.5-116.5,116.5c-35.2,0-66.8-15.3-88.5-39.7c11.2,1.6,22.7,2.4,34.4,2.4c58.3,0,105.5-47.2,105.5-105.5V208.6c-9.4-0.6-18.8-2-28-4.2v85.9c0,58.3-47.2,105.5-105.5,105.5c-11.9,0-23.4-2-34.4-5.9c15.9,28.6,46.8,48.1,81.6,48.1c52.2,0,94.5-42.4,94.5-94.5V145.9C313.5,168,355.4,185,402,185c10.3,0,20.3-0.8,30.2-2.1L448,209.9z" />
                                </svg>
                            </a>
                        </li>
                            ...
                            <a
                                ...
                                <svg
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M12 2C8.686 2 6 4.686 6 8c0 4.092 5.25 11.49 5.487 11.802.26.352.766.352 1.027 0C12.75 19.49 18 12.092 18 8c0-3.314-2.686-6-6-6zm0 9.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7z" />
                                </svg>
                            </a>
                        </li>
                            ...
                            <a
                                ...
                                <svg
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M20.5 4h-17A2.5 2.5 0 001 6.5v11A2.5 2.5 0 003.5 20h17a2.5 2.5 0 002.5-2.5v-11A2.5 2.5 0 0020.5 4zm-17-1A3.5 3.5 0 000 6.5v11A3.5 3.5 0 003.5 21h17a3.5 3.5 0 003.5-3.5v-11A3.5 3.5 0 0020.5 3h-17zm16.472 2L12 11.555 4.528 5h15.944zm.028 12H3.5c-.179 0-.355-.032-.518-.094l6.686-5.593L12 13.782l2.332-2.469 6.686 5.593a1.496 1.496 0 01-.518.094z" />
                                </svg>
                            </a>
                        </li>
                ...
                <div
                    ...
                    <div class="text-center sm:text-left">
                        <p class="text-lg font-medium text-white">Site Map</p>

                        <nav class="mt-8">
                            <ul class="space-y-4 text-sm">
                                <li>
                                    <a class="text-white transition hover:text-white/75" href="index.php">
                                        Home
                                    </a>
                                </li>

                                <li>
                                    <a class="text-white transition hover:text-white/75" href="blog.php">
                                        News & Blogs
                                    </a>
                                </li>

                                <li>
                                    <a class="text-white transition hover:text-white/75" href="FlexHome.php">
                                        Flex Shop
                                    </a>
                                </li>

                                <li>
                                    <a class="text-white transition hover:text-white/75" href="FlexCatelog.php">
                                        Catalog
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="text-center sm:text-left">
                        <p class="text-lg font-medium text-white">Other Services</p>
            ...
            <div class="pt-6 mt-12 border-t border-gray-800">
                <div class="text-center sm:flex sm:justify-between sm:text-left">
                    ...
                    <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0" onclick="window.location ='https://www.linkedin.com/in/sanka-udeshika-6298311bb/'">
                        &copy; 2023 FITNESS FIRST LK. All Right Reserved Developed By <span class="text-rose-600 transition hover:text-rose-500/75" style="cursor: pointer;">Sanka Udeshika</span>
                    </p>
                </div>
            </div>
        </div>
